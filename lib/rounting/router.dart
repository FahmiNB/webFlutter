...
import 'package:ecommerce_admin_tut/pages/developer/developer_page.dart';
...
import 'package:ecommerce_admin_tut/pages/sample/sample_page.dart';
  ...
  switch (settings.name) {
    ...
    case RegistrationRoute:
      ...
      return _getPageRoute(CategoriesPage());
                case SampleRoute:
      return _getPageRoute(SamplePage());
                case DeveloperRoute:
      return _getPageRoute(DeveloperPage());
                case BrandsRoute:
